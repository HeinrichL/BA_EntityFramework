...
//        {
//            _session = new KundenverwaltungModelContainer();
//        }
...
//            TestMember m3 = new TestMember() { Hehe = DateTime.Now };
//            TestMember m4 = new TestMember() { Hehe = DateTime.Now };
//            _ps.SaveAll(new[] { m, m2, m3, m4 }.ToList());
...
//            TestMember m4 = new TestMember() { Hehe = DateTime.Now };
//            var res = _ps.SaveAll(new[] { m, m2, m3, m4 }.ToList());
//            var delete = new[] {m2, m3}.ToList();
//            _ps.DeleteRange(delete);
//            var all = _ps.GetAll<TestMember>();
//            Assert.IsTrue(Enumerable.Except(res, delete).All(elem => all.Contains(elem)));
//            Assert.IsTrue(res.Intersect(delete).All(elem => all.Contains(elem)));
//        }
...
//            catch(Exception e)
//            {
//                Assert.AreEqual(typeof(OptimisticConcurrencyException), e.GetType());
