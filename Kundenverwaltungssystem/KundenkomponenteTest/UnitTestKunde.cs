            ...
            Kunde k2 = new Kunde()
                       {
                            ...
                            Nachname = "ddd",
                            Adresse = new AdresseTyp("Berliner Tor", "7", "22091", "Hamburg"),
                            EmailAdresse = new EmailAdresseTyp("dds@test.de"),
                            Geburtsdatum = new DateTime(1990, 01, 01),
                            Kundenstatus = Kundenstatus.Basic,
                            Telefonnummer = "123456"
                        };
            ks.CreateKunde(k2, r1.ID);
            List<Kunde> expected = new List<Kunde>(new [] {k1, k2});
            List<Kunde> kunden = ((IKundenServicesFuerKurse) ks).GetKundenByIds(new []{k1.Kundennummer, k2.Kundennummer}.ToList());
