...
namespace KurskomponenteTest
{
    ...
    public class UnitTestKurs
    {
        ...
        public void TestBucheKursFuerEinenKundenSuccess()
        {
            ...
            Assert.IsTrue(k1.Teilnehmer.Count == k1.MaximaleTeilnehmeranzahl - 2);
        ...
        public void TestBucheKursFuerEinenKundenKursVoll()
        {
            ...
            {
                Assert.IsTrue(k2.Teilnehmer.Count == k2.MaximaleTeilnehmeranzahl);
            }
            finally
            {
                ps.Delete(k2);
        ...
        public void TestBucheKursFuerZweiKundenSuccess()
        {
            ...
            Assert.IsTrue(k1.Teilnehmer.Count == k1.MaximaleTeilnehmeranzahl - 1);
        ...
        public void TestBucheKursFuerZweiKundenNurEinPlatzFrei()
        {
            ...
            {
                Assert.IsTrue(k2.Teilnehmer.Count == 0);
            }
            finally
            {
                ps.Delete(k2);
